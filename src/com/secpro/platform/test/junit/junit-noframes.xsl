...
<xsl:template match="testsuites">
    <html>
        <head>
            <title>AntUnit Test Results <xsl:value-of select="testsuite/@timestamp"/></title>
    <style type="text/css">
      body {
...
<xsl:template name="pageHeader">
    <h1>Unit Test Results <xsl:value-of select="testsuite/@timestamp"/></h1>
    <table width="100%">
    <tr>
        <td align="left"></td>
...
<xsl:template match="testsuites" mode="header">
    <tr valign="top">
        <th width="80%">Name</th>
        <th>Tests</th>
        <th>Errors</th>
...
<xsl:template match="testsuite/class" name="classes">
    <xsl:for-each select="testsuite/class">
       <!-- create an anchor to this class name -->
        <a name="{@name}"></a>
        <h3>Class <xsl:value-of select="@classname"/></h3>
        ...
        <table class="details" border="0" cellpadding="5" cellspacing="2" width="95%">
          ...
          -->
            <xsl:if test="./error">
         	...
         	<xsl:call-template name="print.test"/>
        </table>
        <p/>
...
<!-- class information -->
<xsl:template match="testcase" name="print.test">
